...
YZ_SRCS =\
  ...
  names.yz valName.yz pattern.yz typeExpr.yz expr.yz typeInfo.yz typeDef.yz declExpr.yz\
  top.yz parser.yz type.yz scheme.yz module.yz decl.yz inf.yz trans.yz compiler.yz\
  main.yz
